...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleRideNotFound(RideNotFoundException exception) {
        return response(HttpStatus.NOT_FOUND, exception.getMessage(), Map.of());
    }

    @ExceptionHandler(InvalidRideStatusException.class)
    public ResponseEntity<ApiError> handleInvalidStatus(InvalidRideStatusException exception) {
